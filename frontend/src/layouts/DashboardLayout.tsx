      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-6 py-8 lg:grid-cols-[260px_1fr]">
        <aside className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <nav className="flex flex-col gap-3 text-sm font-medium text-slate-600">
            ...
            {user?.role === "professional" ? <Link to="/dashboard/professional/appointments">Reservas profesionales</Link> : null}
            ...
            {user?.role === "admin" ? <Link to="/dashboard/admin/manage">Backoffice admin</Link> : null}
