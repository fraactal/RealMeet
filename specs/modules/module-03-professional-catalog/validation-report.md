...
| M3-VAL-005 | Backend tests | `docker-compose exec -T backend pytest` | Tests pasan | pendiente | pendiente |  |
| M3-VAL-006 | Frontend build | `docker-compose exec -T frontend npm run build` | Build pasa | pendiente | pendiente |  |
...
| M3-VAL-010 | Admin catalogo | Crear/actualizar categoria/especialidad | Admin OK, no admin 403 | pendiente | pendiente |  |
| M3-VAL-011 | Especialidades profesional | GET/PATCH propias | Propias, activas, sin duplicados | pendiente | pendiente |  |
| M3-VAL-012 | Perfil publico seguro | Lista/detalle | Sin campos privados | pendiente | pendiente |  |
| M3-VAL-013 | Filtros/paginacion | search/category/specialty/modality/page | Respuesta paginada coherente | pendiente | pendiente |  |
